namespace htaccessExtension.Models
{
    ...
    {
        protected const string _defaultWebConfig = "<configuration><system.webServer></system.webServer></configuration>";
        protected Action<XmlWriter, object> WriteTo;
        protected Func<string, bool, int, object> Translate;
